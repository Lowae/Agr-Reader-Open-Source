...
@Composable
fun TonalPalettes.toLightColorScheme(): ColorScheme {
    val palettes = this
...
@Composable
fun TonalPalettes.toDarkColorScheme(): ColorScheme {
    val palettes = this
...
@Composable
fun TonalPalettes.toColorSchemeAdapter(): ColorScheme {
    return if (LocalDarkTheme.current.isDarkTheme()) {
        toDarkColorScheme()
    } else {
        toLightColorScheme()
    }
